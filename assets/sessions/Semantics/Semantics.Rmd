...
5. Run a loop iterating from 1 to length of `tokens`. At each iteration overwrite `tokens[[i]]` to with a vector containing only those words in `tokens[[i]]` that exist in `retain`. 
